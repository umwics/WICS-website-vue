...
export const admin = [
  ...
  },
  {
    ...
    pronouns: 'she/her',
    description:
      'Hello! My name is Keira, and I am the Treasurer for UMWICS this year! I am in my third year of the Computer Science and Mathematics Join Honours program, and I am excited to help out the wonderful WICS community as a first-time exec. You might find me hanging out in student lounges, performing with the UofM Concert Band, or as a TA in a math or computer science course. I Love to chat, so come say hi!',
